import{r as p,i as d}from"./lit-element.CyV8MMp1.js";import{x as s}from"./directive.D03qP3rJ.js";import{e as f}from"./class-map.B3sySxza.js";class n extends p{static properties={data:{type:Array},keys:{type:Array},actions:{type:Array},darkMode:{type:Boolean,reflect:!0,attribute:"darkmode"}};constructor(){super(),this.data=[],this.keys=[],this.actions=[],this.darkMode=!1}toggleDarkMode(){this.darkMode=!this.darkMode}static styles=d`
        :host {
            display: block;
