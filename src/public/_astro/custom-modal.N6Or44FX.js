import{i as c,r as p}from"./lit-element.CyV8MMp1.js";import{x as l}from"./directive.D03qP3rJ.js";import{n as h,r as g,o as b,t as u}from"./state.DOXniPlE.js";var v=Object.defineProperty,f=Object.getOwnPropertyDescriptor,a=(e,t,o,r)=>{for(var i=r>1?void 0:r?f(t,o):t,s=e.length-1,d;s>=0;s--)(d=e[s])&&(i=(r?d(t,o,i):d(i))||i);return r&&i&&v(t,o,i),i};class m extends p{static get properties(){return{title:{type:String,reflect:!0},description:{type:String,reflect:!0},theme:{type:String,reflect:!0},options:{type:Array}}}constructor(){super(),this.title="",this.description="",this.theme="light",this.options=[]}static get styles(){return c`
      :host {
        --dlg-padding: 1.5rem;
  ...
  `;a([h({type:Array})],n.prototype,"_options",2);a([g()],n.prototype,"isVisible",2);a([g()],n.prototype,"posX",2);a([g()],n.prototype,"posY",2);n=a([u("custom-popup")],n);customElements.define("dialog-content",m);customElements.define("dialog-container",k);
