import{i as d,n as f,r as m}from"./property.DTDKM9eR.js";import{x as s}from"./lit-html.Cs9YtZST.js";import{t as h}from"./custom-element.BhZVzxrc.js";import{r as v}from"./state.5GRZVynF.js";import{T as g}from"./socketManager.C9KItRar.js";import"./idb.DgU9_DZM.js";import"./Logger.BU1C1vw5.js";import"./UserProcessor.CxcZZZ9m.js";var w=Object.defineProperty,C=Object.getOwnPropertyDescriptor,p=(e,r,o,i)=>{for(var t=i>1?void 0:i?C(r,o):r,n=e.length-1,l;n>=0;n--)(l=e[n])&&(t=(i?l(r,o,t):l(t))||t);return i&&t&&w(r,o,t),t};let a=class extends m{constructor(){super(...arguments),this.topCount=3,this._data=null}connectedCallback(){super.connectedCallback(),console.log("TopViewersList añadido al DOM.")}willUpdate(e){e.has("topCount")&&(console.log(`top-count cambiado a: ${this.topCount}`),(isNaN(this.topCount)||this.topCount<=0)&&(console.warn(`Valor inválido para top-count: '${this.topCount}'. Se usará el valor por defecto: 3`),this.topCount=3))}updateData(e){if(!e||typeof e!="object"){console.error("updateData requiere un objeto válido."),this._data=null,this.requestUpdate();return}if(!Array.isArray(e.topViewers)){console.error('La propiedad "topViewers" debe ser un array.'),this._data=null,this.requestUpdate();return}this._data=e,this.requestUpdate()}render(){if(!this._data||!this._data.topViewers||!Array.isArray(this._data.topViewers))return s`
